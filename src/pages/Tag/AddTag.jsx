...
export default function AddTag({user_id, data, setData, show, onClose}) {
                ...
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                  ...
                  <div>
                    ...
                    <TextInput
                      ...
                      className="mt-1"
                      value={formatDate(tag.end_dateOfIdea)}
                      onChange={handleChangeInput}
                    />
                    <p class="mt-1 text-sm text-red-500"> 
                  ...
                  <div>
                    ...
                    <TextInput
                      ...
                      placeholder="mm/dd/yyyy"
                      className="mt-1"
                      value={formatDate(tag.start_dateOfTag)}
                      onChange={handleChangeInput}
                    />
                    <p class="mt-1 text-sm text-red-500"> 
                  ...
                  <div>
                    ...
                    <TextInput
                      ...
                      placeholder="mm/dd/yyyy"
                      className="mt-1"
                      value={formatDate(tag.end_dateOfTag)}
                      onChange={handleChangeInput}
                    />
                    <p class="mt-1 text-sm text-red-500"> 
                      {error.end_dateOfTag}
